    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(max_length=40, choices=[(b'NewInfo', b'NewInfo'), (b'PartTransfer', b'PartTransfer'), (b'FullTransfer', b'FullTransfer'), (b'Breakaway', b'Breakaway')])),
                ('transfer_source', models.CharField(max_length=200)),
                ('transfer_geom', django.contrib.gis.db.models.fields.MultiPolygonField(srid=4326, blank=True)),
